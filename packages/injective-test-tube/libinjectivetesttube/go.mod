...
replace (
	...
	github.com/InjectiveLabs/injective-core => github.com/InjectiveFoundation/injective-core v1.16.0-beta.2
	...
	github.com/ethereum/go-ethereum => github.com/InjectiveLabs/go-ethereum v1.14.11-inj
