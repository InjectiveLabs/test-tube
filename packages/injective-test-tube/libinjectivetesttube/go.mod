...
require (
	...
	github.com/cosmos/ibc-apps/middleware/packet-forward-middleware/v7 v7.0.1 // indirect
	github.com/cosmos/ibc-apps/modules/ibc-hooks/v7 v7.0.0-20231017170841-8fd49ec0f017 // indirect
